...
## [p.113] Introduction to Reproduction
...
7.1 DO ORG ANISMS CREA TE EXA CT COPIES OF
THEMSEL VES?
...
## [p.114] Questions on DNA Copying and Variation
...
## [p.115] Activity on Yeast Growth

How do Organisms Reproduce? 115
Figure 7.1(a)  Binary fission in Amoeba
Activity 7.2 MODES OF REPRODUCTION USED BY SINGLE
ORGANISMS
Activity 7.1
...
This not true for all multi-cellular organisms. They cannot simply
...
into a complete organism. This known as regeneration (see Fig. 7.3).
...
the growing tip of a plant. The cells are then placed in artificial medium where they
...
/square6Spread some cotton a tray and wet it. Place the potato pieces
...
## [p.119] Why the Sexual Mode of Reproduction?

How do Organisms Reproduce? 119
All the modes of reproduction that we have discussed so far allow
new generations to be created from a single individual. This known as
asexual reproduction.
QUESTIONS
?
1. How does binary fission differ from multiple fission?
2. How will an organism benefited if it reproduces through spores?
...
## [p.120] Sexual Reproduction in Flowering Plants
...
the previous generation had. This likely to mess up the control of the
...
reproductive body cells. This achieved by a process of cell division
...
## [p.121] Reproduction in Human Beings
...
On the other hand, there also changes taking place that are
...
face in boys appears a few scattered hairs first, and only slowly does
...
## [p.123] Female Reproductive System
...
takes place in the tes. These are located
...
tes in the secretion of the hormone,
...
special tissue called placenta. This a disc which is embedded in the
...
mind is ready for sexual acts or for having and bring up children.
...
We have noted earlier that repr oduction is the process by which
...
is a cause for concern for many people. This because an expanding
...
## [p.126] Questions on Reproduction
...
to the stigma which is referred to as pollination. This followed by fertilisation.
...
/square6The male reproductive system in human beings consists of tes which produce

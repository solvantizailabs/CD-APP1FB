...
Movements overy small scales will be invisible to the naked eye –
...
organisms, but is fulfilled in different ways. Some organisms use simple
...
purpose of photosynthesis. But is
...
body. Water used in photosynthesis taken up fr om the soil by the
...
## [p.84] Nutrition in Human Beings
...
particles which are small and of the same texture. This achieved by
...
we like, our mouth ‘waters’. This actually not only water, but a fluid
...
canal, it has to be broken into smaller molecules. This done with the
...
stomach, the food now enters the small intestine. This the longest part
...
smaller globules increasing the efficiency of enzyme action. This similar
...
produced. Terrestrial animals can breathe oxygen in the
atmosphere, but animals that live in water need to use the oxygen
dissolved in water.
Activity 5.6
/square6Observe fish in aquarium. They open and close their mouths
...
## [p.91] Transportation in Human Beings

Life Processes 91
5.4 TR ANSPORT A AATION
...
range of haemoglobin content in animal like the buffalo
or cow.
...
body. This useful in animals that have high
...
twice during each cycle in other vertebrates. This known as double
circulation.
Our pump — the heart
Figure 5.10
Schematic sectional
...
arterioles, which results increased resistance to blood flow. It can lead to the rupture
...
cells takes place across thin wall. The capillaries then join together
...
## [p.96] Excretion in Human Beings
...
pressure as blood, except that is
...
into the patient. This similar to the
function of the kidney, but is
...
## [p.98] What you have learnt

Science98
5.5.2 Excretion in Plants use completely different
...
10. What would be the consequences of a deficiency of haemoglobin our bodies?

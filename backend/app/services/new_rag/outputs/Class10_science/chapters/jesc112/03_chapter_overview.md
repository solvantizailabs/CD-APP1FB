...
## [p.195] Activity to Observe Magnetic Effect of Electric Current
...
## [p.196] Activity to Visualize Magnetic Field Lines
...
this pattern demonstrate?  The magnet exerts influence in the region
...
## [p.197] Magnetic Field due to a Current-Carrying Conductor
...
mean that the point of intersection, the compass needle would point
towards two directions, which is not possible.
12.2 MAMAMAGNETIC FIELD DUE TO A CURRENT - --C CCCCARRYING
CONDUCTOR
...
## [p.198] Activity to Observe Magnetic Field Direction
...
purpose.)
/square6Keep the variable of the rheostat a fixed
...
## [p.200] Magnetic Field due to a Current through a Circular Loop
...
shown in Fig. 12.7. This known as the right-hand thumb rule*.
Example 12.1
...
## [p.201] Magnetic Field due to a Current in a Solenoid

Magnetic Effects of Electric Current 201
We know that the magnetic field produced by a curr ent-carrying
...
n times as large as that produced by a single turn. This because the
...
behaves a magnetic north pole, while the other behaves as the
...
## [p.202] Force on a Current-Carrying Conductor in a Magnetic Field

Science202
12.3 FORCE ON A CURRENT ---
--C CCCCARRYING CONDUCTOR
IN A MAGNETIC FIELD
We have lear nt that an electric curr
...
## [p.203] Activity to Demonstrate Force on a Current-Carrying Conductor
...
## [p.204] Domestic Electric Circuits
...
This used as a safety measure, especially for those appliances that
...
parts. This done using a technique called Magnetic Resonance Imaging (MRI). Analysis
...
increases. This called short-circuiting. The use of an electric fuse
...
is 220 V. The third is the earth wire that has green insulation and this connected

...
## [p.208] ECO -SYSTEM — WHAT ARE ITS COMPONENTS?
...
13CHAPTER
W
e have hear d the wor d ‘environment’ often being used on the
...
13.1 ECO -SYSTEM — WHA T ARE ITS COMPONENTS?
...
/square6You might have seen aquarium. Let us try to design one.
/square6What are things that we need to keep in mind when we create
...
Our Environment 209
/square6If we add a few aquatic plants and animals it can become a self-
...
on one another . This series or ganisms taking part at
...
We know that the food we eat acts a fuel to provide us
...
convert into chemical energy. This energy supports all the
...
## [p.212] Ozone Layer and How it is Getting Depleted

Science212
Activity 13.3
and animals. This one of the ways in which they enter the food chain.
...
magnification. This the reason why our food grains such as wheat
...
## [p.213] Managing the Garbage we Produce
...
a large scale would r
esult in the loss of the fertile top-soil. Now disposable paper-cups

...
## [p.171] Electric Current and Circuit
...
say that there is an electric curr ent in the conductor. In a tor ch, we
...
electron posses a negative charge of 1.6 × 10 –19 C.) The electric
...
## [p.173] Electric Potential and Potential Difference
...
is connected to a tank of water kept a higher level, such that there is a
...
No. used in the nichrome across the (volt/ampere)
...
increases linearly – this Ohm’s law.
Activity 11.2
...
temperature remains the same. This called Ohm’s law. In
other words –
V ∝  I (11.4)
or V/I = constant
= R
...
## [p.177] Factors on which the Resistance of a Conductor Depends
...
11.5 FA CTORS ON WHICH THE RESIST ANCE OF A
CONDUCTOR DEPENDS
Figure 11.4
...
Table 11.2, we see that this the resistivity of manganese.
Example 11.6
...
## [p.181] Resistance of a System of Resistors
...
11.6 RESIST ANCE OF A SYSTEM OF RESISTORS
...
= 6 V/ 0.25 A
= 24 Ω .
This the total resistance of the series circuit; it is equal to the sum
...
2. Redraw the circuit of Question 1, putting in ammeter to measure
...
Insert the ammeter in series with the resistor R1, as shown in Fig. 11. Note the ammeter
reading, I1.
Figure 11.11
...
This also the potential difference across each of the individual
...
## [p.188] Heating Effect of Electric Current

Science188
11.7 HEA TING EFFECT OF ELECTRIC CURRENT
...
through a resistor a system of resistors connected to the battery. We
...
dissipated entirely in the form of heat. This known as the heating
...
parallel – (a) 1 Ω  and 10 6 Ω,  (b) 1 Ω  and 10 3 Ω , and 10 6 Ω .
...
H = I2 Rt (11.21)
This known as Joule’s law of heating. The
...
Another common application of Joule’s heating is the fused in
...
## [p.191] Electric Power

Electricity 191
11.8 ELECTRIC POWER
You have studied in your earlier Class that the rate of doing work is
power. This also the rate of consumption of energy.
Equation (11.21) gives the rate at which electric energy is dissipated
or consumed in an electric circuit. This also termed as electric power.
...
= 3.6 × 106 joule (J)
More to Know!
Many people think that electrons are consumed in an electric circuit. This wrong!
...
11. Show you would connect three resistors, each of resistance 6 Ω , so that the

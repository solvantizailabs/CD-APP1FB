...
shorter form. The simplest way to do this to write it in the form of a
word-equation.
...
the reaction.
You must have observed that magnesium ribbon bur ns with a
...
## [p.3] Balanced Chemical Equations
...
oxygen it. There are four oxygen atoms on the RHS and only one on
the LHS.
...
Step VII: Writing Symbols of Physical States   Car efully examine
...
Note that the symbol (g) is used with H 2O to indicate that in this
...
CO(g) + 2H (g)2
340atm C H OH(l)3 →  (1.11)
6CO (aq) 12H O(l) C H O (aq) 6O2 2 6 12 6+ +Sunlight
Chloro
phyll →  2 2 2(aq) 6H O(l)+ (1.12)
   (Glucose)
...
## [p.6] Combination Reaction

Science6
1.2 TYPES OF CHEMIC AL REA CTIONS
...
(ii) Barium chloride + Aluminium sulphate →   Barium sulphate +
     Aluminium chloride
(iii) Sodium + Water  →  Sodium hydr oxide + Hydr ogen
...
We all know that we need energy to stay alive. W e get this energy
...
to give simpler products. This a decomposition reaction. Ferrous
...
Chemical Reactions and Equations 9 99
Activity 1.7
Activity 1.8
...
them carefully.
n Test these gases one by bring a burning candle close
...
## [p.11] Double Displacement Reaction
...
substance formed?
This because oxygen is added to copper and
...
ZnO + C → + Zn CO (1.31)
MnO HCl MnCl H O Cl2 24 2+ → + + (1.32)
...
is commonly known as rusting of iron. Some other metalso get
